                    ...
                    o; )
                        try {
                            ...
                            case 7:
                                ...
                                continue;
                            default:
                                if (!((r = o.trys).length > 0 && r[r.length - 1]) && (6 === u[0] || 2 === u[0])) {
                                    o = 0;
                                    continue
                                }
...
compute: lt,
  get data() {
    ...
    function ue(t) {
        for (var e = null; null === e && t.previousSibling; t = t.previousSibling) {
            e = t.previousSibling;
        }
    ...
    function Rn(t) {
        ...
        function(t) {
            ...
            Xi(t, "touchcancel", en.bind(this, 20), !0)
        }(t),
        function(t) {
            Xi(t, "input", Fe, !0)
        }(t),
                    ...
                    u = o.throttleDom ? function(t, e, n, a) {
                        ...
                        if (r && "HTML" !== r.data.tag) {
                            ...
                            h[0] >= 10 || d)
                                ...
                                n > a + 3e3 ? t.type : (o.dropMutations || (Wn[f] = {
                                    mutation: t,
                                    timestamp: a
                                }),
                                "throttle")
        ...
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(f) {
                ...
                case 8:
                    ...
                    d = Wn[l],
                    delete Wn[l],
                    [4, ta(t, d.mutation, s(), d.timestamp)]) : [3, 11];
                case 9:
                    f.sent(),
                    o = !0,
                    f.label = 10;
    ...
    function da(t, e, n) {
        ...
        case Node.ELEMENT_NODE:
            ...
            case "IFRAME":
                ...
                N.attributes["*O"] = "true",
                M.contentDocument && M.contentWindow && "loading" !== M.contentDocument.readyState && (r = M.contentDocument)),
                se[i](t, o, N, e);
                break;
            case "LINK":
    ...
    function Xa(t, e, n) {
        ...
        void 0 === n && (n = null),
        rt(this, void 0, void 0, (function() {
            var a, r, i, u, c, l, d, f, h, p, v, g, m, b, w, k, S, E, O, M, N, T, x, I, D, j, A, R, L, P, z, H, W, X;
            return it(this, (function(Y) {
                ...
                case 8:
                    ...
                    I = 0,
                    D = M ? ["tag", "attributes", "value"] : ["tag"]; I < D.length; I++)
                        if (O[j = D[I]] && (j === "tag" || j === "attributes" || j === "value"))
                            switch (j) {
                            case "tag":
                                A = Ya(S),
                                R = x ? -1 : 1,
                                r.push(S.id * R),
                                S.parent && M && (r.push(S.parent),
                            ...
                            case "attributes":
                                for (L in O[j])
                                    void 0 !== O[j][L] && r.push(Ua(L, O[j][L], T));
                                break;
                            case "value":
                                Mt(S.metadata.fraud, S.id, O[j]),
                                r.push(y(O[j], O.tag, T, x))
                            }
                    Y.label = 9;
                case 9:
                    return w++,
    ...
    function ir(t, e, n) {
        ...
        if (t) {
            ...
            if (null !== r) {
                ...
                i.fraud && Mt(i.fraud, r.id, n || r.data.value)
            }
        }
        return a
    }
            ...
            return it(this, (function(Y) {
                ...
                case 10:
                    ...
                    M = dn; O < M.length; O++)
                        ...
                        T = ir(W.data.top, W.event),
                        x = ir(W.data.bottom, W.event),
                        I = (null == T ? void 0 : T.hash) ? T.hash.join(".") : "",
    ...
    function gi() {
        ...
        var s, l = function() {
            ...
            if (e) {
                var n = e.split("|");
                n.length >= 5 && t.ts - Ti(n[1]) < 18e5 && (t.session = n[0],
                t.count = Ti(n[2]) + 1,
                t.upgrade = Ti(n[3]),
